...
public class bookarraytest {
	public static void main(String[] args) {
		...
		System.out.print((int)((1 - barray[0].getDiscountRate()) * barray[0].getPrice()) + (int)((1 - barray[1].getDiscountRate()) * barray[1].getPrice()) + (int)((1 - barray[2].getDiscountRate()) * barray[2].getPrice()));
